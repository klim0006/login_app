# Login Application
A Login Application is created by Flutter
...
3. Open simulator before run app (iOS simulator or Android simulator)
4. Run and debug app as normal
5. You will see an amazing Login Application >_<
